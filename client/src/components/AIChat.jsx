    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "var(--bg-app)", borderLeft: "1px solid rgba(255,255,255,0.05)" }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p style={{ fontSize: 11, color: limited ? "#f43f5e" : "#ffffff", margin: 0, fontWeight: 700 }}>
      ...
      >
        {messages.map((msg, i) => (
          <div key={i} style={{
            ...
            <div style={{
              ...
              color: msg.role === "user" ? "#ffffff" : "#94a3b8",
              border: `1px solid ${msg.role === "user" ? "rgba(255, 255, 255, 0.15)" : "rgba(255,255,255,0.08)"}`
            }}>
            ...
            <div style={{
              ...
              background: msg.role === "user" ? "#ffffff" : "rgba(15, 23, 42, 0.6)",
        ...
        {messages.length === 1 && !loading && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 10 }}>
            <p style={{ fontSize: 11, color: "#ffffff", textAlign: "center", fontWeight: 800, textTransform: "uppercase", letterSpacing: "1px" }}>
              Quick Suggestions
            </p>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "flex-end", background: "rgba(255,255,255,0.03)", borderRadius: 16, padding: "6px", border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <button
            ...
            style={{
              ...
              background: input.trim() && !loading ? "#ffffff" : "rgba(255,255,255,0.05)",
              display: "flex", alignItems: "center", justifyContent: "center",
